...
-- Create a transitional admin used to own rows from a pre-authentication
-- database. The application seed replaces this placeholder with the configured
-- administrator before the first login.
INSERT INTO "users" ("id", "email", "password", "name", "role", "active", "created_at", "updated_at")
VALUES (
    'admin',
    'migration-admin@gleba.invalid',
...
UPDATE "planches" SET "user_id" = 'admin' WHERE "user_id" IS NULL;
UPDATE "cultures" SET "user_id" = 'admin' WHERE "user_id" IS NULL;
UPDATE "recoltes" SET "user_id" = 'admin' WHERE "user_id" IS NULL;
UPDATE "fertilisations" SET "user_id" = 'admin' WHERE "user_id" IS NULL;
UPDATE "objets_jardin" SET "user_id" = 'admin' WHERE "user_id" IS NULL;
UPDATE "analyses_de_sol" SET "user_id" = 'admin' WHERE "user_id" IS NULL;
UPDATE "notes" SET "user_id" = 'admin' WHERE "user_id" IS NULL;
